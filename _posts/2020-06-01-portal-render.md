...
I started with a portal based engine, mainly because that was the focus of the material I used as inspiration [Creating a Doom-style 3D engine in C][https://www.youtube.com/watch?v=HQYsFshbkYw].
With portals, the entire 'world' is divided into [convex polygons][https://en.wikipedia.org/wiki/Convex_polygon]. The most important feature of a convex polygon from the point of view of a renderer is that, from any point within the polygon, all wall segments are completely visible. And because no part of any wall can be occluded, there is no need to implement a z-buffer or perform expensive per-pixel visibility tests.

![convex diagram](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/convex.jpg)
...
![sectors diagram](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/sectorsview.png)
...
while(traverseComplete == false)
{
    ...
    // Travel to the next node in the BSP based on which side of the partition line our 'insidePoint' is
...
![subsectors diagram](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/subsectorsview.png)
...
![generate polygon](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/degenerate.png)
...
![colinear segment](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/colinearedge.png)
...
![nonunique portal](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/nonuniqueportal.png)
...
![unique portal](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/uniqueportal.png)
...
![level display](https://raw.githubusercontent.com/violentcat/violentcat.github.io/tree/master/static/img/_posts/doome1m1.png)
